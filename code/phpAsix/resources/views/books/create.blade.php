...
<section>
    <div class="max-w-7xl mx-auto bg-white shadow-lg py-6 sm:px-6 lg:px-8">
        ...
        <button onclick="window.location.href='/books';" class="bg-white text-gray-700 border border-gray-300 px-4 py-2 rounded hover:bg-gray-100 mt-4">Tornar a la llista de llibres</button>
    </div>
</section>
</body>
</html>
